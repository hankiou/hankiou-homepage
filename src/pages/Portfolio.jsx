  ...
  return (
    <>
      <SEO
        ...
        description="Explore Enzo GUENY's portfolio featuring web applications, UI/UX design, pixel art, and development projects. Includes GeoWarmup, Cloverfield from Hiphen, Phenostation Hiphen, and more creative works."
        ...
        structuredData={{
          ...
          description:
            "Portfolio showcasing web development, UI/UX design, and creative projects",
          url: "https://hankiou.com/portfolio",
          author: {
            "@type": "Person",
            name: "Enzo GUENY",
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {error && (
          <div className="text-center py-20">
            <p className="body-base text-red-400 mb-4">
              ...
              <>
                ...
                {regularItems.length > 0 && (
                  <div className="my-12 flex items-center justify-center">
                    ...
                    <span className="px-4 mono-label text-slate-400">
                      All Projects
                    </span>
                    <div className="flex-1 h-px bg-gradient-to-r from-transparent via-accent/30 to-transparent"></div>
                  </div>
